...
class TestPortfolio(unittest.TestCase):
    ...
    def test_str(self):
        ...
        self.assertEqual(str(self.test_portfolio), expected, "Printing wrong summary")
    ...
    def test_buy_shares(self):
        ...
        self.assertEqual(test_share.number_owned, 102, "Incorrect number of shares after buying more")
    ...
    def test_sell_shares(self):
        ...
        self.assertEqual(test_share.number_owned, 1, "Incorrect number of shares after buying more")
